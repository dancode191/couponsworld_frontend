...
function UpdateCoupon(): JSX.Element {
    ...
    const id = +param.coupID!;

    function send(coupon: CouponModel){
        //we making sure the id stay the same. cause its not been update by the form
        coupon.id = id;
        ...
        reader.onload = ()=>{
            ...
            .then(()=>{
                notificationService.success("coupon updated successfuly!");
    ...
    return (
        <div className="UpdateCompCoupon boxGlassLayer1">
                ...
                <input className="inputDesign" type="number" placeholder="Enter coupon quantity" {...register("amount",{
                    ...
                    max: {value: 100, message: "you cant enter coupon amount more then 100 "},
                ...
                <button className="btnDes">Update Coupon</button>
                </form>
